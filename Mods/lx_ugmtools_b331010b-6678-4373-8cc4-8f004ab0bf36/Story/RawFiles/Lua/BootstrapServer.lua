...
Ext.Require("UGM_Tools.lua")
Ext.Require("UGM_Equipment.lua")
Ext.Require("UGM_Animations.lua")
Ext.Require("UGM_StatusManager.lua")
Ext.Require("UGM_UIHotbar.lua")
Ext.Require("UGM_OsiServices.lua")
...
local function RestoreCharactersAnimations()
    ...
    for character, anim in pairs(PersistentVars[currentLevel].animLoop) do
        if HasActiveStatus(character, "DEACTIVATED") == 0 then
            StartCharacterAnimationLoop(anim)
        end
    end
end
